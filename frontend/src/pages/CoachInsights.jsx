...
export default function CoachInsights() {
  // ⚠️ BETA — désactivé. Retirer cette ligne pour réactiver le Radar Coach IA.
  return <AIComingSoon title="Radar Coach IA" icon="🤖" desc="L'analyse IA de tes clients est en cours de finalisation. Elle te dira bientôt exactement sur quel client agir en priorité." />
